...
*---------*---------*---------*---------*---------*---------*---------*-
      ...
      if(k1.eq.0) goto 999
   10 continue
      call getlgg(sline,k1,l,kfch,klch,it)
      if(kfch.gt.0)  then
         sflag=sline(kfch:klch)
...
*---------*---------*---------*---------*---------*---------*---------*-
   ...
   10    continue
      ...
      character string*(*)
      character alphan*37,alphae*38
 
      data alphan/'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_'/
      data alphae/'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_.'/
...
*---------*---------*---------*---------*---------*---------*---------*-
   ...
   20 continue
      ...
      subroutine getlgg(string,k1,k2,kfch,klch,it)
...
*---------*---------*---------*---------*---------*---------*---------*-
      ...
      if(k.eq.0) goto 999
   10 continue
      call getlgg(string,k,l,kfch,klch,it)
      if(kfch.eq.0) goto 999
...
*---------*---------*---------*---------*---------*---------*---------*-
      ...
      logical ifdecl,eldecl,eidecl,cddecl,dkdecl
